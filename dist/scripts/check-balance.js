...
function checkBalances() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const kasheProdBalance = yield connection.getBalance(kasheProd.publicKey);
        ...
        console.log("  Secret Key:", bytes_1.bs58.encode(kasheProd.secretKey));
        console.log("  Address:", kasheProd.publicKey.toBase58());
        console.log("  Balance:", kasheProdBalance / web3_js_1.LAMPORTS_PER_SOL, "SOL");
