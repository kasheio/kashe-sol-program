...
describe("token-2022-pumpfun", () => {
    ...
    it("Airdrop to admin wallet", () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it("buy", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        // Add your test here.
        const tx = yield program.methods
            .buy(new anchor_1.BN(8 * web3_js_1.LAMPORTS_PER_SOL)) //   buy 0.1 sol
            .accounts({
            globalConfiguration: globalConfiguration,
            bondingCurve: bondingCurve,
            mintAddr: mintAddr.publicKey,
...
//# sourceMappingURL=token-2022-pumpfun.js.map