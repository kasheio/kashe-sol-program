...
async function checkBalances() {
    ...
    const idKey = Keypair.fromSecretKey(new Uint8Array([3,67,94,27,176,213,189,216,223,206,94,218,145,93,185,135,187,241,193,81,217,116,43,35,240,39,226,5,245,255,68,74,167,23,49,122,31,5,56,171,105,63,103,84,20,9,238,166,176,148,198,50,165,60,161,35,237,189,15,158,254,222,232,170]));
